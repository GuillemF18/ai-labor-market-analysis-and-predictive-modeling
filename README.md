...
> **Important Note on Rendering:** GitHub does not natively render dynamic or interactive Javascript plots within notebook previews. 
> 
...
> 2. **Watch the live demo:** Check out our [YouTube Walkthrough Video]("[[enlace](https://youtu.be/f-Qh-Iia58g)]") to see the interactive slicing framework, boundary adjustments, and cluster separating planes in action.
